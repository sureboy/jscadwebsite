...
import { SimpleColorizer } from "./SegmentColorizer";
 ...
 */
function parseValue<DefaultType extends number | undefined>(
...
export class GCodeParser {
  ...
  public async parse() {
    ...
    const layerPointsCache: Map<number, { start: number; end: number }> =
      new Map();
